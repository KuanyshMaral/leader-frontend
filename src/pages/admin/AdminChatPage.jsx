...
export default function AdminChatPage() {
  ...
  const loadApplications = () => {
    api.get('/admin/moderation/applications').then(res => setApplications(res.data));
  };
          ...
          <tbody className="divide-y">
            {applications.length === 0 ? (
              ...
              >
                ...
                <td className="px-6 py-4 text-gray-600">{app.product_name}</td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4 text-xs text-gray-400">
                  {new Date(app.last_pending_at).toLocaleString()}
                </td>
              </tr>
            ))}
          </tbody>
